...
const CATEGORIES = [
    ...
    { value: "watch",       icon: "⌚", label: "Watch",       live: true, space: false },
    { value: "jewelry",     icon: "💍", label: "Jewelry",     live: true, space: false },
    { value: "bag",         icon: "👜", label: "Bag",         live: true, space: false },
    { value: "hair",        icon: "💇", label: "Hair",        live: true, space: false },
    { value: "makeup",      icon: "💄", label: "Makeup",      live: true, space: false },
    { value: "nails",       icon: "💅", label: "Nails",       live: true, space: false },
    ...
    { value: "beauty",      icon: "👄", label: "Beauty",      live: true, space: false },
...
export function ReadyScreen({
    ...
    return (
        <div className="screen">
            ...
            {error && <div className="error-banner">{error.replace(/<[^>]*>/g, "").slice(0, 120)}</div>}
