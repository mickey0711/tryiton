...
export default function LoginPage() {
                ...
                <div className={styles.card}>
                    ...
                    {forgotSent ? (
                        <div className={styles.success}>
                            ...
                            <button className={styles.ghost} onClick={() => { setShowForgot(false); setForgotSent(false); }}>
                                ← Back to sign in
                            </button>
                        </div>
                    ) : (
                        <form onSubmit={handleForgot} className={styles.form}>
                            ...
                            <button type="button" className={styles.ghost} onClick={() => setShowForgot(false)}>
                                ← Back to sign in
                            </button>
                        </form>
                    )}
    ...
    return (
        <main className={styles.page}>
            <div className={styles.card}>
                <a href="/" className={styles.logo}>TryItOn ✨</a>
                <p className={styles.sub}>Sign in to see your saved looks</p>
                ...
                <form onSubmit={handleLogin} className={styles.form}>
                    ...
                    <button type="button" className={styles.ghost} onClick={() => setShowForgot(true)}>
                        Forgot password?
                    </button>
                </form>
                ...
                <p className={styles.switchLink}>
                    No account?{" "}
                    <a href="/register" className={styles.switchA}>Create one free →</a>
                </p>
            </div>
        </main>
    );
